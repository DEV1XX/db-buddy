              ...
              <div className="backdrop-blur-2xl bg-white/10 rounded-3xl border border-white/20 p-6 md:p-8 shadow-2xl shadow-white/10 h-full">
                ...
                {databases.length === 0 ? (
                  <div className="text-center py-8">
                    ...
                    <p className="text-slate-300/50 text-sm mt-2">Connect your first database to get started</p>
                  </div>
                ) : (
                  <div className="space-y-3">
                    {databases.map((db) => (
                      <div 
                        key={db.connectionId}
                        className="backdrop-blur-xl bg-white/10 rounded-xl border border-white/20 p-4 hover:bg-white/15 transition-all group"
                      >
                        <div className="flex items-start justify-between">
                          ...
                          <button 
                            ...
                            onClick={() => {
                              if (confirm(`Delete database connection: ${db.database}?`)) {
                                // Add delete functionality here
                                console.log('Delete', db.connectionId);
                              }
                            }}
                          >
              ...
              <div className="backdrop-blur-2xl bg-white/10 rounded-3xl border border-white/20 p-6 md:p-8 shadow-2xl shadow-white/10 h-full">
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                  ...
                  <button 
                    type="submit" 
                    disabled={loading}
                    className="w-full px-6 py-3 backdrop-blur-2xl bg-white/20 border border-white/30 text-white rounded-xl font-semibold hover:bg-white/30 transition-all shadow-[0_0_15px_rgba(255,255,255,0.1)] disabled:opacity-50 disabled:cursor-not-allowed"
                  >
